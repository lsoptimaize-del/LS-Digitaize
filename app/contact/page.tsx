      ...
      <main style={{ flex: 1, paddingTop: 'clamp(7rem, 14vh, 11rem)', paddingBottom: '6rem' }}>
        <div className="contact-grid" style={{
          ...
          <div className="contact-left-col" style={{ position: 'sticky', top: '9rem' }}>
            ...
            <p style={{ fontSize: '1rem', color: 'rgba(0,0,0,0.45)', lineHeight: 1.7, maxWidth: '360px', marginBottom: '3.5rem' }}>
            ...
            <div className="contact-footer" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              <a href="mailto:contact@lsdigitaize.com" style={{ display: 'flex', alignItems: 'center', gap: '1rem', textDecoration: 'none', color: 'rgba(0,0,0,0.6)', transition: 'color 0.2s' }}
                onMouseEnter={e => (e.currentTarget.style.color = '#0A0A0A')}
                onMouseLeave={e => (e.currentTarget.style.color = 'rgba(0,0,0,0.6)')}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', border: '1px solid rgba(0,0,0,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <div>
                  <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.3)', margin: '0 0 0.2rem' }}>Email Us</p>
              ...
              <a href="https://instagram.com/lsdigitaize" target="_blank" rel="noopener noreferrer"
                style={{ display: 'flex', alignItems: 'center', gap: '1rem', textDecoration: 'none', color: 'rgba(0,0,0,0.6)', transition: 'color 0.2s' }}
                onMouseEnter={e => (e.currentTarget.style.color = '#0A0A0A')}
                onMouseLeave={e => (e.currentTarget.style.color = 'rgba(0,0,0,0.6)')}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', border: '1px solid rgba(0,0,0,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <div>
                  <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.3)', margin: '0 0 0.2rem' }}>Instagram</p>
                  <p style={{ fontSize: '0.95rem', margin: 0 }}>@lsdigitaize</p>
                </div>
              </a>

              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: 'rgba(0,0,0,0.6)' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', border: '1px solid rgba(0,0,0,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                ...
                <div>
                  <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.3)', margin: '0 0 0.2rem' }}>Location</p>
          ...
          <div className="contact-right-col">
            <style>{`
              ...
              input::placeholder, textarea::placeholder { color: rgba(0,0,0,0.18); }
            ...
            {step !== 'done' && (
              <div style={{ marginBottom: '3.5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.6rem' }}>
                  <span style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', color: 'rgba(0,0,0,0.3)', letterSpacing: '0.15em', textTransform: 'uppercase' }}>
                    Step {stepIndex + 1} of {STEPS.length - 1}
                  </span>
                  <span style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', color: 'rgba(0,0,0,0.3)' }}>
                    {progressPct}%
                  </span>
                </div>
                <div style={{ height: '1px', background: 'rgba(0,0,0,0.08)', position: 'relative' }}>
            ...
            {step === 'done' ? (
              <div className="contact-step" style={{ paddingTop: '2rem' }}>
                ...
                <h2 style={{ fontFamily: 'var(--font-sevone)', fontSize: 'clamp(2.5rem, 5vw, 4rem)', color: '#0A0A0A', lineHeight: 0.95, marginBottom: '1.5rem' }}>
                  Message<br />Received.
                </h2>
                <p style={{ fontSize: '1.05rem', color: 'rgba(0,0,0,0.5)', lineHeight: 1.7 }}>
              ...
              <div key={step} className="contact-step">
                {/* Step label */}
                <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', color: '#4A9EFF', letterSpacing: '0.25em', textTransform: 'uppercase', marginBottom: '1.2rem' }}>
                  {STEP_META[step].num}
                </p>

                {/* Question */}
                <h2 style={{ fontFamily: 'var(--font-sevone)', fontSize: 'clamp(1.8rem, 3.5vw, 2.8rem)', color: 'rgba(0,0,0,0.9)', lineHeight: 1.1, marginBottom: '0.6rem' }}>
                  {STEP_META[step].question}
                </h2>
                {STEP_META[step].hint && (
                  <p style={{ fontSize: '0.88rem', color: 'rgba(0,0,0,0.35)', fontFamily: 'var(--font-geist-mono)', marginBottom: '2rem' }}>
                    {STEP_META[step].hint}
                  </p>
                )}
                      ...
                      {SERVICES.map(s => {
                        ...
                        return (
                          ...
                          style={{
                            ...
                            borderRadius: '99px',
                            border: isSelected ? '1.5px solid #4A9EFF' : '1px solid rgba(0,0,0,0.15)',
                            background: isSelected ? 'rgba(74,158,255,0.12)' : 'transparent',
                            color: isSelected ? '#4A9EFF' : 'rgba(0,0,0,0.6)',
                    ...
                    {['Under ₹50,000', '₹50,000 - ₹2,00,000', '₹2,00,000+'].map(b => (
                      <button key={b} onClick={() => { setForm(p => ({ ...p, budget: b })); setTimeout(advance, 250); }}
                        style={{
                          padding: '1.2rem 2rem',
                          borderRadius: '12px',
                          border: form.budget === b ? '1.5px solid #4A9EFF' : '1px solid rgba(0,0,0,0.15)',
                          background: form.budget === b ? 'rgba(74,158,255,0.12)' : 'transparent',
                          color: form.budget === b ? '#4A9EFF' : 'rgba(0,0,0,0.8)',
                          fontFamily: 'var(--font-geist-mono)',
                          fontSize: '1rem',
                          textAlign: 'left',
                          cursor: 'pointer',
                ...
                <div style={{ display: 'flex', gap: '1rem', marginTop: '2.5rem', alignItems: 'center' }}>
                  ...
                  {stepIndex > 0 && (
                    <button
                      ...
                      style={{ background: 'none', border: 'none', color: 'rgba(0,0,0,0.3)', fontFamily: 'var(--font-geist-mono)', fontSize: '0.75rem', cursor: 'pointer', letterSpacing: '0.1em', textTransform: 'uppercase' }}
                    >
                      ← Back
                    </button>
                  )}
                ...
                {step !== 'service' && step !== 'message' && (
                  <p style={{ marginTop: '1rem', fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', color: 'rgba(0,0,0,0.2)', letterSpacing: '0.1em' }}>
...
function FaqSection() {
  ...
  return (
    <section ref={sectionRef} style={{ background: '#FAFAF7', borderTop: '1px solid rgba(0,0,0,0.06)', padding: 'clamp(5rem, 10vh, 9rem) 0' }}>
      <div style={{ maxWidth: '1360px', margin: '0 auto', padding: '0 clamp(1.5rem, 5vw, 4rem)' }}>
        ...
        <div ref={headingRef} style={{ ...initialHidden, display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: 'clamp(4rem, 7vh, 6rem)' }}>
          <span style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.7rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: '#4A9EFF' }}>
            Frequently Asked
          </span>
          <h2 style={{ fontFamily: 'var(--font-sevone)', fontSize: 'clamp(3rem, 6vw, 6rem)', color: '#0A0A0A', lineHeight: 0.9, letterSpacing: '-0.02em', margin: 0 }}>
            Questions.
          </h2>
        </div>
            ...
            >
              ...
              >
                <span style={{
                  ...
                  color: open === i ? '#0A0A0A' : 'rgba(0,0,0,0.7)',
                  lineHeight: 1.25,
                ...
                <div style={{
                  ...
                  <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                    <line x1="7" y1="1" x2="7" y2="13" stroke={open === i ? '#4A9EFF' : 'rgba(0,0,0,0.5)'} strokeWidth="1.5" strokeLinecap="round"/>
                    <line x1="1" y1="7" x2="13" y2="7" stroke={open === i ? '#4A9EFF' : 'rgba(0,0,0,0.5)'} strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                </div>
              </button>
