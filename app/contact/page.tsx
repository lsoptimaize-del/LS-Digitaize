          ...
          <div className="contact-left-col" style={{ position: 'sticky', top: '9rem' }}>
            ...
            <div className="contact-footer" style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
              <a href="mailto:contact@lsdigitaize.com" style={{ display: 'flex', alignItems: 'center', gap: '1rem', textDecoration: 'none', color: 'rgba(0,0,0,0.6)', transition: 'color 0.2s' }}
                ...
                <div>
                  <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.3)', margin: '0 0 0.2rem' }}>Email Us</p>
              ...
              <a href="https://instagram.com/lsdigitaize" target="_blank" rel="noopener noreferrer"
                ...
                <div>
                  <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.3)', margin: '0 0 0.2rem' }}>Instagram</p>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', color: 'rgba(0,0,0,0.6)' }}>
                ...
                <div>
                  <p style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(0,0,0,0.3)', margin: '0 0 0.2rem' }}>Location</p>
            ...
            {step !== 'done' && (
              <div style={{ marginBottom: '3.5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.6rem' }}>
                  <span style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.65rem', color: 'rgba(0,0,0,0.3)', letterSpacing: '0.15em', textTransform: 'uppercase' }}>
                    Step {stepIndex + 1} of {STEPS.length - 1}
                  </span>
                  <span style={{ fontFamily: 'var(--font-geist-mono)', fontSize: '0.65rem', color: 'rgba(0,0,0,0.3)' }}>
                    {progressPct}%
                  </span>
                </div>
            ...
            {step === 'done' ? (
              ...
              <div key={step} className="contact-step">
                ...
                {step !== 'service' && step !== 'message' && (
                  <p style={{ marginTop: '1rem', fontFamily: 'var(--font-geist-mono)', fontSize: '0.65rem', color: 'rgba(0,0,0,0.2)', letterSpacing: '0.1em' }}>
