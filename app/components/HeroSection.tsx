    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-hidden flex items-center">
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(90deg, rgba(74,158,255,0.2) 0%, rgba(74,158,255,0.05) 40%, transparent 100%)',
        ...
        <motion.div
          ...
          style={{
            background: 'linear-gradient(90deg, rgba(126,193,245,0.15) 0%, rgba(74,158,255,0.08) 50%, transparent 100%)',
      ...
      >
        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap gap-5 sm:gap-6 justify-start">
            ...
            <Link
              href="/services"
              className="group inline-flex flex-col items-center gap-1 text-[10px] sm:text-xs uppercase tracking-[0.2em] sm:tracking-[0.25em] font-semibold transition-colors duration-300 hover:text-black mt-2 sm:mt-0"
      ...
      <div className="hidden md:flex absolute bottom-12 left-1/2 -translate-x-1/2 flex-col items-center gap-2 z-20">
        <span className="text-[10px] tracking-[0.35em] uppercase text-black/50">SCROLL DOWN</span>
